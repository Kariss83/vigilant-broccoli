...
class Categories(models.Model):
    ...
    name = models.CharField(max_length=200, help_text="Entrez le nom d'une catégorie.")
...
class Favorites(models.Model):
    searched_product = models.ForeignKey(
        Products, on_delete=models.CASCADE, related_name="searched_product"
    )
    substitution_product = models.ForeignKey(
        Products, on_delete=models.CASCADE, related_name="substitution_product"
    )
