    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                messages.error(request, ("Erreur de connexion - Veuillez reéssayer..."))
        ...
        return render(
            request, "registration/login.html", {"form": CustomAuthenticationForm()}
        )
...
def register_user(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.error(
                request, ("Erreur de Création de Comptes - Veuillez reéssayer...")
            )
